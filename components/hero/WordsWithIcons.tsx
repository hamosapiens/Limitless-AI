...
export default function WordsWithIcons({
  ...
  return (
    <p
      className="mt-6 text-base md:text-lg leading-relaxed text-white/75 md:text-balance max-w-sm md:max-w-md lg:max-w-lg text-center lg:text-left mx-auto lg:mx-0"
      aria-label={text}
    >
