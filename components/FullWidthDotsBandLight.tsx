...
export default function FullWidthDotsBandLight({
  active = true,
  height = 270,
  spacing = 22,
  speed = 220,
  ...
  }, [active, spacing, speed, thickness, pauseLeadMs, ellipseXScale, ellipseYScale, centerYOffset]);
...
<div className="pointer-events-none absolute inset-x-0 top-0 h-[90px] bg-gradient-to-b from-white via-white/70 to-transparent" />
    </div>
  );
}
