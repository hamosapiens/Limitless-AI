...
export default function BottomSheetZoom({
  open,
  onClose,
  initialRoute = "root",
  title = "Wallet options",
}: BottomSheetZoomProps) {
          ...
          <div className="p-4">
            ...
            {route === "root" ? (
              <>
                ...
                <div className="mt-3 grid gap-2">
                  <button
                    ...
                    className="w-full rounded-lg border px-4 py-3 text-left hover:bg-gray-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-600"
                  >
                    View Private Key
                  </button>
                  <button
                  ...
                  <button
                    ...
                    className="w-full rounded-lg border border-red-300 px-4 py-3 text-left text-red-600 hover:bg-red-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-600"
                  ...
                  <button
                    onClick={onClose}
                    className="mt-3 w-full rounded-lg border px-4 py-2 hover:bg-gray-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-600"
                  >
                    Close
                  </button>
                </div>
              ...
              <>
                ...
                {route === "remove-wallet" && (
                  <>
                    <p id={`${descId}-danger`} className="text-sm text-gray-700">
